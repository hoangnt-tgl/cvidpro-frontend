								...
								<div className="row max-w1000 m-auto">
										...
										<div className="pricingtable-wrapper style2 bg-white">
											<div className="pricingtable-inner">
												<div className="pricingtable-price"> 
													<h4 className="font-weight-300 m-t10 m-b0">Người tìm việc</h4>
												...
												<div className="m-t20"> 
													<Link to={"/employee/register"} className="site-button radius-xl"><span className="p-lr30">Sign Up</span></Link> 
												</div>
											</div>
										</div>
									</div>
									...
									<div className="col-sm-12 col-md-6 col-lg-6 p-lr0">
										<div className="pricingtable-wrapper style2 bg-white">
											<div className="pricingtable-inner">
												<div className="pricingtable-price"> 
													<h4 className="font-weight-300 m-t10 m-b0">Nhà tuyển dụng</h4>
													{/* <div className="pricingtable-bx"> $  <span>29</span> /  Per Installation </div> */}
												</div>
												{/* <p>Lorem ipsum dolor sit amet adipiscing elit sed do eiusmod tempors labore et dolore magna siad enim aliqua</p> */}
												<div className="m-t20"> 
													<Link to={"/company/register"} className="site-button radius-xl"><span className="p-lr30">Sign Up</span></Link> 
												</div>
											</div>
										</div>
									</div>
